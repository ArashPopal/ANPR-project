...
class Home_page(Tk):
    ...
    def Open_In(self):
        ...
        self.filename = filedialog.askopenfilename(initialdir="image2",
                                                   title="Incoming Vehicles", filetype=(
            ("png file", "*.png"),("jpeg file", "*.jpg"),  ("all file", "*.*")))
        self.right_most_frame = Frame(self.Right_frame, width=1000, height=700)
        self.right_most_frame.place(x=10, y=100)
        my_image = ImageTk.PhotoImage(Image.open(self.filename))
        self.my_image_label = Label(self.right_most_frame, image=my_image).place(x=0, y=0)
        # self.filename = filedialog.askopenfilename(initialdir="image2",
    ...
    def Open_Out(self):
        ...
        self.filename1 = filedialog.askopenfilename(initialdir="image2",
                                                   title="Leaving Vehicles", filetype=(
            ("png file", "*.png"),("jpeg file", "*.jpg"),  ("all file", "*.*")))
        self.right_most_frame = Frame(self.Right_frame, width=1000, height=700)
        self.right_most_frame.place(x=10, y=100)
        my_image1 = ImageTk.PhotoImage(Image.open(self.filename1))
        self.my_image_label = Label(self.right_most_frame, image=my_image1).place(x=0, y=0)
